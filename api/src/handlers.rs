...
use crate::auth::{
	BasicAuthMiddleware, BasicAuthURIMiddleware, MUGLE_BASIC_REALM, MUGLE_FOREIGN_BASIC_REALM,
};
use crate::chain;
	...
	P: PoolAdapter + 'static,
{
	...
	if let Some(api_secret) = api_secret {
		let api_basic_auth =
			"Basic ".to_string() + &to_base64(&("mugle:".to_string() + &api_secret));
