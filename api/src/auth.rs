...
lazy_static! {
	pub static ref MUGLE_BASIC_REALM: HeaderValue =
		HeaderValue::from_str("Basic realm=MugleAPI").unwrap();
	pub static ref MUGLE_FOREIGN_BASIC_REALM: HeaderValue =
		HeaderValue::from_str("Basic realm=MugleForeignAPI").unwrap();
}
