...
use crate::consensus::{
	...
	DMA_WINDOW, INITIAL_DIFFICULTY, KERNEL_WEIGHT, MAX_BLOCK_WEIGHT, MUGLE_BASE, OUTPUT_WEIGHT,
...
/// Default unit of fee per tx weight, making each output cost about a Muglecent
pub const DEFAULT_ACCEPT_FEE_BASE: u64 = MUGLE_BASE / 100 / 20; // 500_000
...
/// Default to mugle-cent/20 if global config unset.
