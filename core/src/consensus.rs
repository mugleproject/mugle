...
pub const MILLI_MUGLE: u64 = MUGLE_BASE / 1_000;
/// Micromugle, a thousand of a millimugle
pub const MICRO_MUGLE: u64 = MILLI_MUGLE / 1_000;
/// Nanomugle, smallest unit, takes a billion to make a mugle
pub const NANO_MUGLE: u64 = 1;
