...
fn test_pibd_copy_real() {
	...
	let src_root_dir = format!("/Users/yeastplume/Projects/mugle_project/server/chain_data");
	let dest_root_dir = format!("/Users/yeastplume/Projects/mugle_project/server/.chain_data_copy");
	clean_output_dir(&dest_root_dir);
