...
use mugle_store::Error::NotFoundErr;
...
impl Chain {
	...
	/// Specific tmp dir.
	/// Normally it's ~/.mugle/main/tmp for mainnet
	/// or ~/.mugle/test/tmp for Testnet
	...
	pub fn txhashset_write(
		...
		// Write txhashset to sandbox (in the Mugle specific tmp dir)
