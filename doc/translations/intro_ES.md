# Introducción a Mimblewimble y Mugle
...
Mugle es un proyecto de software de código abierto que implementa una cadena de bloques Mimblewimble y rellena los espacios
necesarios para una implementación completa de la cadena de bloques y moneda criptográfica.

El objetivo principal y las características del proyecto Mugle son:
...
esto en mente, tratamos de explicar el desarrollo técnico de Mimblewimble y cómo se aplica en Mugle. Esperamos que este
...
Mugle y contribuir de cualquier manera posible.

Para lograr este objetivo, presentaremos los principales conceptos necesarios para una buena comprensión de Mugle como
...
de Curva Elíptica (ECC) para sentar las bases sobre las que se basa Mugle y luego describir todos los elementos clave de las
...
medida en este principio. Mimblewimble y la implementación de Mugle también lo hacen.
...
Esta sección explica con más detalle la creación de transacciones discutiendo cómo se introduce el cambio y el requisito de pruebas de rango para que se demuestre que todos los valores no son negativos. Ninguno de los dos es absolutamente necesario para entender MimblewimbleWimble y Mugle, así que si tienes prisa, no dudes en ir directamente a
[Poniendo todo junto](https://github.com/wimel/mugle/blob/master/doc/intro.md#putting-it-all-together).
