# Introduction to Mimblewimble and Mugle
...
Mugle is an open source software project that implements a Mimblewimble
blockchain and fills the gaps required for a full blockchain and
cryptocurrency deployment.

The main goal and characteristics of the Mugle project are:
...
A detailed post on the step-by-step of how Mugle transactions work (with graphics) can be found [in this Medium post](https://medium.com/@brandonarvanaghi/mugle-transactions-explained-step-by-step-fdceb905a853).
...
to explain the technical buildup of Mimblewimble and how it's applied in Mugle. We hope
this document is understandable to most technically-minded readers. Our objective is
to encourage you to get interested in Mugle and contribute in any way possible.

To achieve this objective, we will introduce the main concepts required for a good
understanding of Mugle as a Mimblewimble implementation. We will start with a brief
description of some relevant properties of Elliptic Curve Cryptography (ECC) to lay the
foundation on which Mugle is based and then describe all the key elements of a
...
Deterministic wallets heavily rely on this principle. Mimblewimble and the Mugle
...
Mugle, so if you're in a hurry, feel free to jump straight to
