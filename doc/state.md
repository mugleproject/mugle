...
The full state of a Mugle chain consists of all the following data:
...
With a full Mugle state, we can validate the following:
...
Data storage for outputs, range proofs and kernels in Mugle is simple: a plain
