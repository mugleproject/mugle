...
A design goal of Mugle is that all structures be as easy to implement and
...
are simple to specify (no scripts) and Mugle is written in a language with
...
Mugle itself does not need proof-of-spentness but it is a good thing to support
