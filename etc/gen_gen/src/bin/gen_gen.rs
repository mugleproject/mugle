...
use mugle_miner_plugin as plugin;
use mugle_store as store;
use mugle_util::{self as util, ToHex};
use mugle_wallet as wallet;

use mugle_core::core::hash::Hashed;
use mugle_core::core::verifier_cache::LruVerifierCache;
use mugle_keychain::{BlindingFactor, ExtKeychain, Keychain};
...
fn main() {
...

	{
		...
		let tmp_chain = setup_chain(".mugle.tmp", core::pow::mine_genesis_block().unwrap());
